...
Public repos that show how I build when the goal is small scope and real deployment.
...
- Shipping Lirava from MVP to App Store and first revenue
- Growing GetBack from live product to repeatable user acquisition
